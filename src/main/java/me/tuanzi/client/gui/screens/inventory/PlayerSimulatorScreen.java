...
public class PlayerSimulatorScreen extends AbstractContainerScreen<PlayerSimulatorMenu> {
    private static final Identifier TEXTURE = Identifier.withDefaultNamespace("textures/gui/container/dispenser.png");

    public PlayerSimulatorScreen(PlayerSimulatorMenu menu, Inventory inventory, Component title) {
